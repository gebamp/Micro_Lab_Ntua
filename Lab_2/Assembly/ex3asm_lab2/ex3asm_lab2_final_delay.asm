...
; ex2asm_lab2.asm
;
; Created: 25/10/2019 12:35:19 pµ
; Author : Superminiala
;
...
restore:                                          ;Keeps reading until PA7 is reset
  ...
  clr interupt_clr
  ldi interupt_clr,(1<<TOIE1)                     ;Enable timer interupts
  out TIMSK,interupt_clr
  clr interupt_clr
  ldi interupt_clr,(1<<CS12)|(0<<CS11)|(1<<CS10)  ;Set interval of increment of timer ck/1024
  out TCCR1B,interupt_clr
  clr interupt_clr
...
ISR_TIMER1_OVF:
	clr interupt_clr                              ;Disable timer interupts
	ldi interupt_clr,(0<<TOIE1)
	out timsk,interupt_clr
	ldi interupt_clr,(0<<CS10)|(0<<CS11)|(0<<CS10)
	out TCCR1B,interupt_clr
